...
def ziskej_cislo_jmeno_obci(odkaz):
...
ziskej_cislo_jmeno_obci("https://www.volby.cz/pls/ps2017nss/ps32?xjazyk=CZ&xkraj=12&xnumnuts=7103")
count = 0
for cislo in cislo_obci:
    ...
    if response.status_code != 200:
        ...
        for pocet_hlasu_druha_tabulka in hledam_pocet_hlasu_strany_druha_tabulka:
            ...
            print(pocet_hlasu_druha_tabulka.text)
        ...
        for procento_druha_tabulka in hledam_procenta_strany_druha_tabulka:
            ...
            print(procento_druha_tabulka.text)
